...
groups.setup = function()
  ...
  local groups = {
    ...
    GruvboxRed = { fg = colors.aqua },
    GruvboxRedBold = { fg = colors.aqua, bold = config.bold },
    GruvboxGreen = { fg = colors.yellow },
    GruvboxGreenBold = { fg = colors.yellow, bold = config.bold },
    GruvboxYellow = { fg = colors.blue },
    GruvboxYellowBold = { fg = colors.blue, bold = config.bold },
    GruvboxBlue = { fg = colors.neutral_purple },
    GruvboxBlueBold = { fg = colors.neutral_purple, bold = config.bold },
    GruvboxPurple = { fg = colors.light },
    GruvboxPurpleBold = { fg = colors.light, bold = config.bold },
    GruvboxAqua = { fg = colors.aqua },
    GruvboxAquaBold = { fg = colors.aqua, bold = config.bold },
    GruvboxOrange = { fg = colors.light1 },
    GruvboxOrangeBold = { fg = colors.light1, bold = config.bold },
    GruvboxRedSign = { fg = colors.red, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxGreenSign = { fg = colors.purple, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxYellowSign = { fg = colors.blue, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxBlueSign = { fg = colors.blue, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxPurpleSign = { fg = colors.light, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxAquaSign = { fg = colors.aqua, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxOrangeSign = { fg = colors.light1, bg = colors.bg1, reverse = config.invert_signs },
    GruvboxRedUnderline = { undercurl = config.undercurl, sp = colors.red },
    GruvboxGreenUnderline = { undercurl = config.undercurl, sp = colors.purple },
    GruvboxYellowUnderline = { undercurl = config.undercurl, sp = colors.blue },
    GruvboxBlueUnderline = { undercurl = config.undercurl, sp = colors.blue },
    GruvboxPurpleUnderline = { undercurl = config.undercurl, sp = colors.light },
    GruvboxAquaUnderline = { undercurl = config.undercurl, sp = colors.aqua },
    GruvboxOrangeUnderline = { undercurl = config.undercurl, sp = colors.light1 },
    ...
    String = { fg = colors.purple, italic = config.italic },
